...
| 3. Design | ออกแบบโครงสร้างฐานข้อมูล UseCaseDiagram , ClassDiagram , SequenceDiagram และออกแบบหน้าจอผู้ใช้งาน (Wireframe/UI) |
...
| 7. Maintenance | ตรวจทานระบบหลังจากนำไปติดตั้ง และแก้ไขตาม Feedback และสรุปผลโครงงาน |
